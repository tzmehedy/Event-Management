  ...
  return (
    <form action="">
      <FieldSet>
        <FieldGroup className="space-y-10">
          <div className="border-2 border-muted px-5 py-10 space-y-3 inset-shadow-2xs rounded-lg">
            ...
            <Field>
              <FieldLabel htmlFor="title" className="text-bold text-md text-muted-foreground">
                Event Title
              </FieldLabel>
          ...
          <div className="border-2 border-muted px-5 py-10 space-y-3 inset-shadow-2xs rounded-lg">
            ...
            <div className="space-y-5">
               ...
               <Field>
                ...
                <div className="">
                  <Textarea className="focus-visible:border-[#DC143C] h-40" name="description" id="description" placeholder="Describe about your event"/>
                </div>
              </Field>
            </div>
          </div>
      ...
      <div className="flex justify-end">
        <Button className="mt-5 cursor-pointer bg-[#DC143C] text-white" variant={"outline"} type="submit"><Plus/>Create Event</Button>
      </div>
    </form>
  );
}
